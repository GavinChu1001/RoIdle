...
## Project: Rune Frontier Idle

RO-like idle web game. Personal hobby project, future plan to integrate WeChat mini-program for potential monetization. Sole developer.

- **Stack:** Vanilla JS frontend, Node.js backend (server.js), file-based persistence
- **Architecture:** game.js is the monolithic core being actively modularized into `src/` modules
