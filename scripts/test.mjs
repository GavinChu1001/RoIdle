...
assert.match(collectionPageSource, /renderCollectionPage/, 'Collection page renderer should exist.');
assert.match(collectionPageSource, /equipmentCount/, 'Collection page should render equipment collection count.');
assert.match(main, /installCollectionRenderRuntime/, 'Main should install the collection render runtime.');
